      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-dark-muted text-sm max-w-md mb-6">
              {data?.description || 'Your trusted platform for investing in Indian stocks. Trade with confidence, build your portfolio, and achieve your financial goals.'}
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-dark-muted hover:text-white text-sm transition-colors">
                  Help Center
                </a>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-dark-border">
          <p className="text-dark-muted text-sm text-center">
            {data?.copyright || `© ${new Date().getFullYear()} StockApp. All rights reserved.`}
          </p>
          <p className="text-dark-muted/50 text-xs text-center mt-2">
